...
func SetupArgs() (string, string, string) {
	...
	template := cmd.String("template", "./templates", "if given a file, the file of the template to be rendered; if given a directory, all templates under the directory will be rendered")
